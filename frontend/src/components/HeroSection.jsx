...
const HeroSection = () => {
  return (
    <div className='flex flex-col justify-center items-center md:flex-row'>
        <div className='p-4'>
        <h1 className='text-6xl font-mono font-extrabold'> Welcome to My portfolio</h1>
         <div className='ml-6 mt-4 text-4xl '>  ~ We make dreams come true </div>
         <motion.div className='bg-base p-8 rounded-full mt-4 h-10  ml-10 flex  items-center shadow shadow-md shadow-gray-800' initial={{ opacity: 0 }}
    animate={{ opacity: 100 }}
