...
const About = ({data}) => {
  return (
    ...
    <h1 className='text-6xl font-mono font-extrabold mt-24 '>About us</h1>
    </div>
   <div className='grid grid-cols-2 justify-center items-center p-40'>
    <div className='flex justify-center items-center  '>
     <p> hey, i {data.name} and i am doing this this in my life bla bla bla
     i am {data.age} year  old Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam saepe eos impedit. Illo reiciendis, expedita amet quasi quia mollitia in sed, similique accusantium exercitationem consequuntur enim fuga tenetur culpa blanditiis? 
    ...
    <div className='flex justify-center items-center mb-12 pt-0 '>
      <img className='w-[50vh] h-[50vh]' src="../public/images/logo.png" alt="" />
    </div>
   </div>
    </div>
